<template>
  <div class='slide'>
    <el-menu
      ...
      <el-menu-item index="/home/write" route="/home/write" title="写信">
        <i class="el-icon-close"></i>
        <span slot="title">写信</span>
      </el-menu-item>
      <el-menu-item index="/home/letter" route="/home/letter" title="信件">
        <i class="el-icon-message"></i>
        <span slot="title">信件</span>
      </el-menu-item>
      <el-menu-item index="/home/contacts" route="/home/contacts" title="通讯录">
      ...
      <el-submenu
        ...
        <el-menu-item index='/home/account/logout' :route='thisRoute' @click="logout">
      ...
      <el-submenu
        index="/home/settings"
        title="账户" class="settings">
        <template slot="title">
          <i class="el-icon-setting"></i>
          <span slot="title">设置</span>
        </template>
        <el-menu-item index='/home/settings/about' :route='thisRoute' @click="about">
          关于
        </el-menu-item>
      </el-submenu>
      <!-- <el-menu-item index="5" route="/" class="settings" title="设置">
        <i class="el-icon-setting"></i>
        <span slot="title">设置</span>
      </el-menu-item> -->
    </el-menu>
    <el-dialog
      ...
      width="60%">
      <h2>Vmail 模拟邮箱客户端</h2>
      <p>若不知道密码，需要先在邮箱：设置->账户->开启IMAP/STMP服务获取授权码，授权码即为客户端登录密码</p>
    </el-dialog>
  </div>
...
<script>
  export default {
    ...
    created () {
      ...
      if (path.match(/\/write/)) {
        this.defaultActive = '/home/write'
      } else if (path.match(/\/letter/)) {
        this.defaultActive = '/home/letter'
      } else if (path.match(/\/contacts/)) {
        this.defaultActive = '/home/contacts'
      } else {
...
.el-menu-slide .account {
  position: absolute;
  width: 100%;
  bottom: 56px;
}
.el-menu-slide .settings{
  position: absolute;
  width: 100%;
  bottom: 0;
}
